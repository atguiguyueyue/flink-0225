    ...
    public static void main(String[] args) throws Exception {
        ...
        keyedStream.process(new KeyedProcessFunction<Tuple, WaterSensor, Tuple2<String, Double>>() {
            ...
            public void open(Configuration parameters) throws Exception {
                aggState = getRuntimeContext().getAggregatingState(new AggregatingStateDescriptor<Integer, Tuple2<Integer, Integer>, Double>("agg-state", new AggregateFunction<Integer, Tuple2<Integer, Integer>, Double>() {
                    @Override
            ...
            public void processElement(WaterSensor value, Context ctx, Collector<Tuple2<String, Double>> out) throws Exception {
                ...
                //取出状态中的数据
                Double avgResult = aggState.get();

                out.collect(Tuple2.of(value.getId(), avgResult));
